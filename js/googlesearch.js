...
function googleSearch() {
  ...
  this.active = false;
  this.sources.push('art/trash.png');
  ...
  this.sources.push('art/urwaifu.png');
  ...
  this.trashPic2 = new Image();
  this.trashPic2.src = this.sources[7];
  ...
  this.draw = function() {
    ...
    if(this.trashOpen){
      context.drawImage(this.trashPic2, this.trashPic.X, this.trashPic.Y, this.trashPic.width, this.trashPic.height);
    }
